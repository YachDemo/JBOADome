				...
				<ul class="tpl-left-nav-menu">
					...
					<li class="tpl-left-nav-item"><a href="javascript:;"
						...
						<ul class="tpl-left-nav-sub-menu">
							<li><a
								href="${pageContext.request.contextPath }/cla/findPageCla.action">
									<i class="am-icon-angle-right"></i> <span>查看报销单</span>
							</a> <a
								href="${pageContext.request.contextPath }/cla/toaddCla.action">
									<i class="am-icon-angle-right"></i> <span>添加报销单</span>
							</a></li>
						</ul></li>
					<li class="tpl-left-nav-item"><span>&nbsp;</span></li>
					<li class="tpl-left-nav-item"><a href="javascript:;"
						...
						<ul class="tpl-left-nav-sub-menu">
							...
							</a> <a href="${pageContext.request.contextPath }/lea/leave!sava_Tolea"> <i class="am-icon-angle-right"></i>
									<span>申请请假</span>
							</a></li>
						</ul></li>
					<li class="tpl-left-nav-item"><span>&nbsp;</span></li>
