	...
	<form id="formId"
		...
		<table style="width: 100%;">
			...
			<tr>
				...
				<td>待处理人： ${voucher.sysEmployeeByNextDealSn.name }</td>
			</tr>
		</table>
		<br>
		<hr>
		<table style="width: 100%;">
			...
			<tr style="text-align: center;">
				...
				<td colspan="3" align="center"><input type="hidden" id="vll"
					name="claimVoucher.status" value=""> <input type="hidden"
					id="result" name="checkResult.result" value="">
					<div class="am-btn-toolbar">
						<div class="am-btn-group am-btn-group-xs" style="float: none;">
							<button id="sptg" style="border-radius: 15px;" type="button"
								class="am-btn am-btn-default am-btn-secondary">
								<span class="am-icon-save"></span>审批通过
							</button>
						</div>
						<div class="am-btn-group am-btn-group-xs" style="float: none;">
							<button id="spjj" style="border-radius: 15px;" type="button"
								class="am-btn am-btn-default am-btn-warning">
								<span class="am-icon-archive"></span>审批拒绝
							</button>
						</div>
						<div class="am-btn-group am-btn-group-xs" style="float: none;">
							<button id="dh" style="border-radius: 15px;" type="button"
								class="am-btn am-btn-default am-btn-warning">
